...
# alembic executes from the /migrations directory so it won't find src module unless we do this
...
from src.bootstrap import get_config
...
def _get_connection_string() -> str:
    ...
    db_parameters = app_config.DB_CONNECTION_PARAMETERS
